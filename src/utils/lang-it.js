...
export const ItCatalog = {
    "messages": {
        ...
        "coll-sr": "Includi nell'addestramento",
        "coll-sr-desc": "Se selezionata, le posizioni di questa raccolta saranno usate nella sezione {#train}: {#train-positions}.",
        "comment": "Commento",
        "confirm": "Conferma",
        ...
        "home-page-header": "Ciao, benvenuto in {#_appName}!",
        ...
        "placeholder-add-tag": "Aggiungi un tag…",
        ...
        "settings-fsrs-retention-80": "Buono (meno ripassi)",
        ...
        "toast-xgid-copied-to-clipboard": "XGID copiato negli appunti.",
        ...
        "train-pip-comment": "#### Giocatore in alto:\n# {bpc} ({bpdiff})\n\nCasa: {bpc_home}, fuori: {bpc_out}<br/>\n\n#### Giocatore in basso:\n# {wpc} ({wpdiff})\nCasa: {wpc_home}, fuori: {wpc_out}",
