...
export const EnCatalog = {
    "messages": {
        ...
        "coll-sr": "Include in training",
        "coll-sr-desc": "If selected, the positions in this collection will be used in the {#train}: {#train-positions} section.",
        "comment": "Comment",
        "confirm": "Confirm",
        ...
        "home-page-header": "Hello, welcome to {#_appName}!",
        ...
        "settings-about-acknowledgements-text": "{#_appName} makes use of the following components:",
        ...
        "settings-fsrs-retention-80": "Good (less reviews)",
        "settings-fsrs-retention-85": "Strong",
        "settings-fsrs-retention-90": "Very strong",
        ...
        "toast-xgid-copied-to-clipboard": "XGID copied to clipboard.",
        ...
        "train-pip-comment": "#### Top player:\n# {bpc} ({bpdiff})\n\nHome: {bpc_home}, outer: {bpc_out}<br/>\n\n#### Bottom player:\n# {wpc} ({wpdiff})\nHome: {wpc_home}, outer: {wpc_out}",
